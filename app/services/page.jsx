            ...
            return (
              ...
              >
                <div className="flex w-full justify-between items-center">
                  ...
                  <Link href={services.href} className="w-[70px] h-[70px] flex justify-center items-center bg-white rounded-full group-hover:bg-accent transition-all duration-500 hover:-rotate-45">
